...
class Serie
{
    ...
    #[Assert\NotBlank(message : "Serie's is mandatory !")]
    #[Assert\Length(min:1, max:255, minMessage: "Minimum {{ value }} character", maxMessage: "Maximum {{ value }} characters")]
    #[ORM\Column(length: 255)]
    private ?string $name = null;

    #[Assert\Length(min:10, max:4000, minMessage: "Minimum {{ limit }} character", maxMessage: "Maximum {{ limit }} characters")]
